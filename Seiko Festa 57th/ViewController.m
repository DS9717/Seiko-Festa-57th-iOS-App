...
-(void)viewWillAppear:(BOOL)animated {
    ...
    //趣味研
    Display = [[UIButton alloc]initWithFrame:CGRectMake(92.5, 242, 135, 90)];
    ...
    viewAllButton2 = [[UIButton alloc]initWithFrame:CGRectMake(self.view.bounds.size.width - 60, 242, 60, 90)];
    ...
    //バンド
    Band = [[UIButton alloc]initWithFrame:CGRectMake(92.5, 468, 135, 90)];
    ...
    //講堂･小講堂
    Performance = [[UIButton alloc]initWithFrame:CGRectMake(92.5, 694, 135, 90)];
    ...
    //ステージ
    Stage = [[UIButton alloc]initWithFrame:CGRectMake(92.5, 920, 135, 90)];
